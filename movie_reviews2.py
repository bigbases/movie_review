# -*- coding: utf-8 -*-
"""
Created on Mon Feb  3 00:36:36 2020
...
def crawling(desire_):
    with open("D:\lecture\\movie review\\new_data_review\\confidential assignment/review_data.json", "w", encoding='utf-8') as write_file:
        page_number = 1
        number = 1
        while(page_number<=desire_):
            driver.get("https://movie.naver.com/movie/bi/mi/pointWriteFormList.nhn?code=142384&type=after&isActualPointWriteExecute=false&isMileageSubscriptionAlready=false&isMileageSubscriptionReject=false&page={}".format(page_number)) 
