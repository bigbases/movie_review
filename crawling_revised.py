...
# 수집 데이터 : 리뷰어 단위로 수집 -> 리뷰텍스트, helpfulness votes, rating, movie title
# 리뷰어 단위로 수집한 데이터는 json 파일로 저장함. (리뷰어 한 명 = json 파일 하나)
# correlation score는 sentiment analysis를 통해 sentiment score를 구한 후, spearman coefficient 계산.
