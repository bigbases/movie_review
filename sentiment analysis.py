...
def read_data(filename):
        with open(filename, 'r', encoding='utf8') as f:
                ...
                data = data[1:]
        return data
train_data = read_data('ratings_train.txt') # data 다운로드 링크(네이버 영화 리뷰 데이터)  : https://github.com/e9t/nsmc/
...
#filename1 = open("333.csv", 'r', encoding='utf-8')
...
for i in range(0,num):
    ...
    try:
        with open(file, encoding='UTF-8') as json_file:
            ...
            for i in range(0, num):
                sc = predict_pos_neg(json_data["data"][i]["review"])
                #if (sc>0.5): 최종 확률이 0.5보다 크면 긍정
                json_data["data"][i]["sentiment score"] = sc # sentiment score : 0.0 ~ 1.0
