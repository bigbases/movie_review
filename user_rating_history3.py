...
def rating_list_crawler(desired_):
    ...
    while(page_number != desired_):
        ...
        for i in range(1, 11):
            driver.get("https://movie.naver.com/movie/bi/mi/pointWriteFormList.nhn?code=164192&type=after&isActualPointWriteExecute=false&isMileageSubscriptionAlready=false&isMileageSubscriptionReject=false&page={}".format(page_number)) 

            f = open("D:\lecture\\movie review\\new_data_review\\default/review_history.txt".format(((page_number-1)*10)+i), "a+t")
